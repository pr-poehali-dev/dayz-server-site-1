...
const PRODUCTS = [
  ...
  { id: 15, name: "ATACS", category: "Снаряжение", price: 199, badge: null, desc: "Military Clothing Retexture — камуфляж ATACS. Капюшон в слот очков, шлем на голову", icon: "Shield" },
  { id: 16, name: "MULTICAM", category: "Снаряжение", price: 199, badge: null, desc: "Military Clothing Retexture — камуфляж MULTICAM. Капюшон в слот очков, шлем на голову", icon: "Shield" },
  { id: 17, name: "PIXEL", category: "Снаряжение", price: 199, badge: null, desc: "Military Clothing Retexture — камуфляж PIXEL. Капюшон в слот очков, шлем на голову", icon: "Shield" },
  { id: 18, name: "ACUPAT", category: "Снаряжение", price: 199, badge: null, desc: "Military Clothing Retexture — камуфляж ACUPAT. Капюшон в слот очков, шлем на голову", icon: "Shield" },
  { id: 19, name: "BLACK OPS", category: "Снаряжение", price: 249, badge: "Редкое", desc: "Military Clothing Retexture — камуфляж BLACK OPS. Капюшон в слот очков, шлем на голову", icon: "Shield" },
  { id: 20, name: "FLORA", category: "Снаряжение", price: 199, badge: null, desc: "Military Clothing Retexture — камуфляж FLORA. Капюшон в слот очков, шлем на голову", icon: "Shield" },
  { id: 21, name: "MULTICAM DESERT", category: "Снаряжение", price: 199, badge: null, desc: "Military Clothing Retexture — камуфляж MULTICAM DESERT. Капюшон в слот очков, шлем на голову", icon: "Shield" },
  { id: 22, name: "VEGETATO", category: "Снаряжение", price: 199, badge: null, desc: "Military Clothing Retexture — камуфляж VEGETATO. Капюшон в слот очков, шлем на голову", icon: "Shield" },
  { id: 23, name: "WOODLAND", category: "Снаряжение", price: 199, badge: null, desc: "Military Clothing Retexture — камуфляж WOODLAND. Капюшон в слот очков, шлем на голову", icon: "Shield" },
  { id: 24, name: "WOODS", category: "Снаряжение", price: 199, badge: null, desc: "Military Clothing Retexture — камуфляж WOODS. Капюшон в слот очков, шлем на голову", icon: "Shield" },
  { id: 25, name: "GHILLE BLACK", category: "Снаряжение", price: 349, badge: "Редкое", desc: "Маскировочный костюм Ghille Black. Капюшон в слот очков, шлем на голову", icon: "Eye" },
  ...
  { id: 26, name: "Снегоход Ямаха", category: "Транспорт", price: 379, badge: null, desc: "Надежный снегоход для зимних локаций", icon: "Truck" },
  { id: 27, name: "Аптечка военная", category: "Ресурсы", price: 99, badge: null, desc: "x10 бинтов, x5 морфина, x3 кровь, антибиотики", icon: "Heart" },
  { id: 28, name: "Лодка Zodiac", category: "Транспорт", price: 249, badge: null, desc: "Моторная лодка для морских маршрутов", icon: "Anchor" },
  { id: 29, name: "Набор рейдера", category: "Ресурсы", price: 349, badge: "Выгодно", desc: "Взрывчатка, инструменты для взлома, дымовые гранаты", icon: "Bomb" },
